...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#e9b570' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#e9b570',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#e9b570',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#e9b570',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #e9b57030 0%, #fff 0%)`,
})
